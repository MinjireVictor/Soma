...
public class StudentExamPapersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_student_exam_papers);
        ...
        exam = "exam1";
        reference3=FirebaseDatabase.getInstance().getReference("Schools").child(key).child("Examinations").child(grade)
        ...
        exam="exam2";
        reference4=FirebaseDatabase.getInstance().getReference("Schools").child(key).child("Examinations").child(grade)
                .child(exam).child(subject).child("timestamp");
        ...
        exam="exam3";
        reference5=FirebaseDatabase.getInstance().getReference("Schools").child(key).child("Examinations").child(grade)
                .child(exam).child(subject).child("timestamp");
        ...
        reference6=FirebaseDatabase.getInstance().getReference("Students").child(student_id).child("ExaminationAns").child(exam)
        ...
        reference6.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Toast.makeText(StudentExamPapersActivity.this, "student timestamp1= "+student_tmstmp, Toast.LENGTH_SHORT).show();
        ...
        exam="exam2";
        refernce7=FirebaseDatabase.getInstance().getReference("Students").child(student_id).child("ExaminationAns").child(exam)
                .child(subject).child("timestamp");
        refernce7.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String student_tmstmp=dataSnapshot.getValue(String.class);
                Toast.makeText(StudentExamPapersActivity.this, "student timestamp2= "+student_tmstmp, Toast.LENGTH_SHORT).show();
                if (student_tmstmp!=null){
        ...
        exam="exam3";
        reference8=FirebaseDatabase.getInstance().getReference("Students").child(student_id).child("ExaminationAns").child(exam)
                .child(subject).child("timestamp");
        reference8.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(DataSnapshot dataSnapshot) {
                String student_tmstmp=dataSnapshot.getValue(String.class);
                Toast.makeText(StudentExamPapersActivity.this, "student timestamp3= "+student_tmstmp, Toast.LENGTH_SHORT).show();
...
//                        Snackbar.LENGTH_LONG).show();
                if (resultsType.equals("view examResults")) {

                    if (teacherTimestamp>studentTimestamp){
                        Snackbar.make(getWindow().getDecorView().getRootView(), "You have not done this test", Snackbar.LENGTH_LONG).show();

                    }else{
                        startActivity(new Intent(StudentExamPapersActivity.this, ViewResultsExamStudent.class));
                    }
                }
                else if(available.equals(grade+subject+exam+ " available")){

                    final AlertDialog.Builder alertDialog= new AlertDialog.Builder(StudentExamPapersActivity.this);
                    alertDialog.setTitle("Start Exam")
                            .setMessage("Make sure you have everything in place and press yes");
                    alertDialog.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            reference2=FirebaseDatabase.getInstance().getReference("Students").child(student_id).child("ExaminationAns").child(exam).child(subject);
                            reference2.removeValue();
                            startActivity(new Intent(StudentExamPapersActivity.this, DoExamPapersActivity.class));
                        }
                    });
...
//                        Snackbar.LENGTH_LONG).show();
    ...
    public void onBackPressed() {
        startActivity(new Intent(StudentExamPapersActivity.this,StudentSubjectActivity.class));
    }
}