...
public class ViewUploadedResultsTeacher extends AppCompatActivity {
    ...
    TextView correctAns1, correctAns2, correctAns3, correctAns4, correctAns5, correctAns6,
            ...
            correctAns49, correctAns50;
    DatabaseReference databaseReference,studentIdRef;
    SharedPreferences DataPreference;
    SharedPreferences.Editor dataEditor;
    String grade, subject, exam, examQuestion, key, student_id, status,student_name;
    Button View_paper;
    ProgressDialog pd;
    TextView tv_student_name,tv_score;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_view_uploaded_results_teacher);
        ...
        String name=getIntent().getStringExtra("student name");
    ...
    private void updateAnswers(String student_id){
        pd = new ProgressDialog(ViewUploadedResultsTeacher.this);
        pd.setMessage("Fetching results...");
        pd.show();
        examQuestion = "1";
        Toast.makeText(this, "student id= "+ student_id, Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "exam= "+ exam, Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "subject= "+ subject, Toast.LENGTH_SHORT).show();
        Toast.makeText(this, "examq= "+ exam, Toast.LENGTH_SHORT).show();
    ...
    private void compareAns(final String examQuestion, final String student_answer) {
        ...
        for (int i=0; i<=50; i++){
            databaseReference = FirebaseDatabase.getInstance().getReference("Schools").child(key)
                    .child("ExaminationAns").child(grade).child(exam).child(subject).child(String.valueOf(i));
            final int finalI = i;
            databaseReference.addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (correctAns != null && student_answer!=null) {
                        if (correctAns.equals(student_answer)) {
                            status = "correct";
                            Status(status, String.valueOf(finalI), correctAns);
                        } else {
                            status = "wrong";
                            Status(status, String.valueOf(finalI), correctAns);
                        }
    ...
    private void Status(String status, String examQuestion, String correctAns) {
        if (examQuestion.equals("0")) {
            if (status.equals("correct")) {
                mark1.setImageResource(R.drawable.check);
            } else {
                mark1.setImageResource(R.drawable.incorrect);
                correctAns1.setText(correctAns);
            }
        } else if (examQuestion.equals("1")) {
            if (status.equals("correct")) {
                mark2.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark3.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark4.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark5.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark6.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark7.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark8.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark9.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark10.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark11.setImageResource(R.drawable.check);
            } else {
            ...
            if (status.equals("correct")) {
                mark12.setImageResource(R.drawable.check);
            } else {
